...
def train_teacher(teacher, data_train_loader, data_test_loader, optimizer, num_epochs):
...
def main(opt):
    ...
    if opt.dataset == 'imagenet':
        ...
        optimizer_S = torch.optim.SGD(net.parameters(), lr=opt.lr_S, 
        ...
        if opt.dataset == 'MNIST':
            ...
            # use torchvision models
                ...
                teacher = eval(f'models.{opt.teacher_model_name}(pretrained = False)')
                teacher.conv1 = nn.Conv2d(1,
                                      teacher.conv1.out_channels,
                                      teacher.conv1.kernel_size,
                                      teacher.conv1.stride,
                                      teacher.conv1.padding,
                                      teacher.conv1.dilation,
                                      teacher.conv1.groups,
                                      teacher.conv1.bias,
                                      teacher.conv1.padding_mode)
    ...
    for epoch in range(opt.n_epochs):
        ...
        for i in range(120):
            ...
            loss = (loss_one_hot * opt.oh 
                   + loss_information_entropy * opt.ie
